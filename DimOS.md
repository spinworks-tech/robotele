...
| --- | --- | --- | --- |
| robot â†’ DimOS | `robotele/<id>/telemetry` | `joint_state` (`JointState`) | 15 joints, degrees converted to radians |
| robot â†’ DimOS | `robotele/<id>/telemetry` | `battery_percent` (`Float32`) | 0-100 |
| DimOS â†’ robot | `robotele/<id>/autonomy_goal` | `cmd_vel` (`Twist`, input) | see "Driving the robot" |
