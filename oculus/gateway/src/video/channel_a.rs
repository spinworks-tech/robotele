...
//! byte stream via `roboprotocol_core::video::NalReassembler`. Identical
//! to operator-console's `video/channel_a.rs`.
...
impl ChannelAReceiver {
    ...
    /// (start code + NAL payload) once this chunk completed a NAL.
